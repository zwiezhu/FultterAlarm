...
class AlarmVolumeService : Service(), SensorEventListener {
    private val TAG = "AlarmVolumeService"
    ...
    override fun onCreate() {
        super.onCreate()
        Log.d(TAG, "AlarmVolumeService created")
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        Log.d(TAG, "AlarmVolumeService started with startId: $startId")
        return START_STICKY
    }
    
    override fun onDestroy() {
        super.onDestroy()
        Log.d(TAG, "AlarmVolumeService destroyed")
            ...
            while (keepMaxVolume.get()) {
                try {
                    ...
                    if (currentVolume < maxVolume) {
                        Log.d(TAG, "Forcing volume to maximum: $maxVolume (was: $currentVolume)")
    ...
    companion object {
        fun startService(context: Context) {
            val intent = Intent(context, AlarmVolumeService::class.java)
